...
class StatusNo {
	...
	const PRODUCT_LINE_ADD_SUCCESS = 407; //产品封面成功
	const PRODUCT_LINE_ADD_FAILED = 408; //产品封面成功
	...
	public static $status_msg = [
		...
		self::PRODUCT_LINE_ADD_SUCCESS => '产品封面成功',
		self::PRODUCT_LINE_ADD_FAILED => '产品封面成功',
